    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, Mirrors Mens.com.
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with Mirrors Mens
          ...
          agreed to or set forth in writing by Mirrors Mens, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to Mirrors Mens's acceptance. This means
          Mirrors Mens may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, Mirrors Mens
        ...
        <p>
          ...
          and it is accepted by Mirrors Mens. Prices for products displayed on
          ...
          website may differ from those in stores that stock Mirrors Mens
          products, as these stores are independent of Mirrors Mens.
          Mirrors Mens reserves the right to amend pricing for any pricing
          ...
          submitted an online order, Mirrors Mens will notify you of the error
        ...
        <p>
          ...
          Mirrors Mens reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse Mirrors Mens if it pays, any
          taxes, except for those based on Mirrors Mens's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by Mirrors Mens for when the
          ...
          are beyond our control. Mirrors Mens cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by Mirrors Mens, customer
          may not cancel such accepted order without Mirrors Mens’s prior
          ...
          expenses. The product(s) must be returned to Mirrors Mens within
        ...
        <p>
          ...
          indemnify and hold Mirrors Mens harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>Mirrors Mens</p>
        <p style={{ fontWeight: "500" }}>Kalopul 05, Kathmandu, Nepal</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@inishbashyal.com</span>
        </p>
      </div>
    </div>
  );
