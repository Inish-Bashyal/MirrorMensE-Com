...
import TermsImage from "../Image/handmadeCrafts/handmade4.jpeg";
  ...
  return (
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p>
          Thank you for shopping with Mirrors Mens! We appreciate your business
          and your interest in our equipment. We want to make sure you
        ...
        <p>
          ...
          agreed to in writing by Mirrors Mens.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to Mirrors Mens's acceptance. We may refuse to
        ...
        <p>
          ...
          Mirrors Mens. Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock Mirrors Mens products. We
        ...
        <h2>Taxes</h2>
        <p>
          The prices quoted for the Products include Nepal's prevailing
          Goods and Services Tax (GST). Customer is responsible for paying any
          taxes, except for those based on Mirrors Mens's income. If
          Mirrors Mens is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without Mirrors Mens's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold Mirrors Mens harmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between Mirrors Mens and
