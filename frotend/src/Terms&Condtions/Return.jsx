...
import TermsImage from "../Image/handmadeCrafts/handmade3.jpeg";
  ...
  return (
    <div className="container__0">
      ...
      <div className="content-container">
        <p>
          Thank you for shopping with Mirrors Mens! We want to ensure your
        ...
        <p>
          ...
          purchase. Please allow up to 15-20 days for the refund to be
        ...
        <p>
          ...
          support@inishbashyal.com
          <br />
          <span style={{ fontWeight: "500" }}>Phone  </span>:  +977-9810081542
          <br />
        </p>
        <p>
