 ...
 const footSocial = [
   {
     ...
     path: "https://www.facebook.com/inish99",
   },
  //  {
  //    id: 2,
  ...
  //  },
   {
     ...
     path: "https://www.instagram.com/inishbashyal/",
   },
   {
     id: 4,
     icon: <LinkedInIcon className="likedin_icon" fontSize="large" />,
     path: "https://www.linkedin.com/in/inish-bashyal-3736801b5/",
   },
 ];
              ...
              <div className="foot_logo">
                <Link to="/" style={{ textDecoration: "none" }}>
                  <img
                    ...
                    alt="Mirrors Mens logo"
                  />
                  <h1 className="Foot_heading">Mirrors Mens</h1>
                </Link>
              </div>
          ...
          <div className="container_Footer">
            <div className="sub_footer_wrapper">
              ...
              <div className="foot_copyright">
                <p>
                  &copy; {currYear} | Mirrors Mens, All Rights Reserved.
                  <span>
                    <a href=""> | Built by Inish Bashyal</a>
                  </span>
                </p>
              </div>
            </div>
