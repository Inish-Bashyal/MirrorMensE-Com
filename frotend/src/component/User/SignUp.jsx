          ...
          <form className={classes.form}>
            ...
            >
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The Mirrors Mens Terms & Conditions"
              ...
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The Mirrors Mens Terms Of Use"
                  className={classes.checkbox}
            ...
            >
              I acknowledge Mirrors Mens will use my information in accordance
              with its
